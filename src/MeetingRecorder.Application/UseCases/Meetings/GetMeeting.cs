...
public class GetMeeting(IMeetingRepository meetings)
{
    public async Task<MeetingDto> ExecuteAsync(string requesterId, string meetingId, CancellationToken ct = default)
    {
